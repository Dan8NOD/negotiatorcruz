...
There are negotiations this method will not win, and the skill worth more than
...
3. **Genuine deadlock.** Both sides are correct and the positions are
   incompatible.
...
Run the diagnosis when:

- **Nothing has moved across three conversations** despite the sequence being
  run correctly.
...
internal cover, or delay.

**Tells.** Enthusiasm with no process detail. Requests for detailed pricing
without any scoping conversation. Deadlines that pass without consequence. No
...
**What to do.** Name it once, without accusation, and stop investing.
...
**Tells.** Pronouns drift to "they" (Chapter 9). Every agreement is
provisional. Timelines slip for reasons attributed to unnamed others. Your
champion can't tell you who presents (Chapter 27).

**The test.** Ask for a decision with a date. Someone with authority gives you
one or explains the mechanism. Someone without gives you a feeling.

**What to do.** Change the room, protecting the relationship with your contact.

```
  "You've been carrying this internally and I don't want
   that to fall entirely on you. Who else should be in the
...
mandates, hard budget ceilings, an incompatible technical requirement.
...
This is what the `acknowledge` family is for, and these are among the hardest
...
ACKNOWLEDGEMENT, name where it landed
  ...
  "It sounds like this conversation has run its course for you."
  "It seems like continuing this isn't worth your time anymore."
  "It sounds like you've said everything you're going to say on this."
  "It seems like you're done negotiating and just want an answer."
  "It sounds like there's nothing more you can do."
  "It seems like you've given up on working with us."
  "It sounds like you're waiting for me to just accept where
   this landed."
  "It looks like there's real pressure on you to end this one
   way or another."
  "It seems like you don't have any other questions."
  "It looks like there's real pressure on you to end this one
   way or another."
```
...
### The decision before you continue

Before investing further in any negotiation showing these signs, answer four
questions:

1. **What happens if I negotiate?** Best case and worst case, honestly.
2. **What happens if I don't?** Your actual alternative.
3. **Does this violate anything I hold?** Some deals are not worth their terms.
4. **Who else is affected?** Your delivery team, your other clients, your own
   people.
...
Now you know, it isn't personal, and you can decide what the relationship is
worth on its own terms.

**A clean ending.** Underrated. A negotiation that ends explicitly, without
resentment, leaves a door open. A negotiation that dies silently closes one.

**A different room.** The no-authority fix working.

**What good does not sound like:** renewed enthusiasm with no new commitment.
In a failing negotiation, warmth without a scheduled next step and a named
attendee is the same signal you already diagnosed.
