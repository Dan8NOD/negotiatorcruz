...
3. Anything in the suspected column becomes a question for the next call,
   written verbatim.
4. Then: list everyone on the client side who would be consulted, and mark who
   has spoken to you in the last ninety days. The gap is the risk.
5. Finally, name which of the three leverages you actually hold. If the answer
   is only positive, the renewal is weaker than the forecast says.
...
| Metric | Target |
|---|---|
| **Read window** | Renewal work begins 90+ days out. Binary. |
| **Criticism surfaced** | At least one genuine complaint obtained before terms are discussed. |
| **Audit precedes increase** | The increase is never the first thing said. Binary. |
| **Leverage named** | Rep can state which of the three types they hold. Positive-only is a flag. |
| **Committee mapped** | Renewal stakeholders identified and contacted, not assumed. |

---

## Failure mode

**Treating the renewal as an administrative event.** The rep sends the paper,
assumes continuity, and discovers in week two that the account has been
quietly unhappy for eight months and has already taken a competitor call.

Nobody escalates a slow decline. They just don't renew.

**On tape:** the phrase "just a formality" anywhere in a renewal conversation.

**The recovery:**

```
  "I've been treating this like paperwork and I don't think
   I've earned that. What's the honest version of how this
   year went for you?"
```
