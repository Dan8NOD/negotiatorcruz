...
3. The operator may use only Read and Disarm tools. **No solutions, no policy,
   no numbers.** Four minutes minimum before Steer is permitted.
4. Score two things: did the operator's volume rise, and how long before they
   offered something.
...
| Metric | Target |
|---|---|
| **Time in Read** | Four minutes minimum before any solution is offered. Timed. |
| **Story completed** | The counterpart finished their account without interruption. Binary. |
| **Volume differential** | Operator's volume stayed flat while theirs rose. Scored from tape. |
| **Small thing delivered** | Whatever they named, done same-day. Binary. |
| **Grievance summarized** | A "that's right" obtained on the grievance, not just the facts. |
| **Policy position** | "Our terms state" never appears in the first five minutes. Binary. |
...
would concede that the explanation was unnecessary. Now the settlement has to
be larger than it needed to be, purely to compensate for the interruption.

**On tape:** a number, a date, or the word "policy" inside the first two
minutes.
