...
3. The operator's goal is to get the card's contents said out loud by the
   counterpart.
4. Reveal the card. Discuss which label moved it and which bounced.
5. Swap.
...
| Metric | Target |
|---|---|
| **Concealed objection surfaced** | Did the hidden thing get said out loud by the other side? Binary, and the only outcome that matters. |
| **Delivery temperature** | Flat and warm. Any heat scores zero regardless of accuracy. |
| **Silence after** | Full pause held. A negative label with a follow-on sentence doesn't count. |
| **Density** | One per exchange. Two in a row scores as a failure. |
| **Precision** | Did the label name something specific, or gesture vaguely at "something"? Vague labels are a starting move, not a finishing one. |

---

## Failure mode

**Softening it into nothing.** The rep feels the negative, reaches for the
label, and sands the edges off on the way out: *"I mean, I could be totally
wrong here, and obviously you know your business better than me, but I just
sort of wondered whether maybe there might be some small hesitation?"*

Nothing lands. The hedging communicates that the rep is uncomfortable with what
they're saying, which invites the other side to be comfortable dismissing it.

**What it looks like on tape:** more than two qualifiers before the label
arrives. "I could be wrong," "maybe," "sort of," "a little."

**The recovery:** say it again, once, clean.

```
  "Let me try that again without the hedging. It seems like
...
grammar.** *"Sounds like you don't trust me"* delivered with an edge is not a
tool, it is a complaint, and it will be answered as one. The test is whether
you would be equally content with either answer. If you need them to say "no,
I do trust you," you are fishing for reassurance, and they can tell.
