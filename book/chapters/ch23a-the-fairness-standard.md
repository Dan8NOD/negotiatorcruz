...
- **Early, before terms.** The invitation has to precede the thing it protects
  against, or it reads as damage control.
- **You hold the stronger position.** This is where it does the most work.
  Power that invites correction stops being threatening, and a counterpart who
  isn't defending against your leverage will negotiate on substance.
- **They've been burned before.** Chapter 13's trust-repair territory. An
  explicit standard is worth more than any assurance.
- **The relationship outlives the deal.** Renewals, long implementations,
  anything with a second conversation in it.
...
- **It's a one-shot transaction with no relationship.** Fine to skip. It costs
  nothing but it buys nothing either.
- **As a substitute for an actual concession.** Offering fairness while
  refusing to move is a rhetorical device and lands as one.
...
FAIRNESS, pre-authorize the refusal
  ...
  "If this ever starts to feel one-sided, that's on me to fix,
   not you to absorb."
...
matching what the last vendor did. Asking them to define it converts an
argument about justice into a specification you can build against.
...
anyone says this and how much it changes a room when someone does.
...
**They define fair, and it's cheaper than you feared.** Frequently. What
someone means by fair is usually smaller and more specific than the anxiety you
built around it.

**They relax.** Observable. A counterpart braced for extraction who is handed a
