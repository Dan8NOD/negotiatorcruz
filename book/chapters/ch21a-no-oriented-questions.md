...
Chapter 12 established the principle: people agree to things they are free to
refuse, so you go and get the "no" on purpose. That chapter used it to open
people up.

This one uses it to **ask for the decision.**
...
- **You're asking for the decision.** The whole point.
- **You've summarized and heard "that's right."** Chapter 22 clears you for
...
NO-ORIENTED — ask for the decision
  ...
  "Is it too soon to talk next steps?"
...
NO-ORIENTED — the specific ask
  ...
  "Would it be impossible to move the date?"
  "Would it be horrible to revisit the price?"
```

**"Is there any reason we can't proceed?"** is the workhorse. It asks for the
close and simultaneously requests the objection, and it is nearly impossible to
...
then?"* Both are legitimate, both work, and both are one degree of tone away
from being manipulative. If there is any edge in your voice, don't.
...
**"No, don't close the file."** Followed, almost always, by an explanation of
what's really been happening. The effort of refusing the exit is itself a
re-commitment.

**A pause, then honesty.** *"Honestly? I don't know."* That's a real answer and
it is far more workable than the enthusiastic non-answer you'd have got from a
